...
def coverapi_active():
	return get_setting('provider.coverapi', 'false') == 'true'

def gamato_active():
	return get_setting('provider.gamato', 'false') == 'true'

def greek_movies_active():
	return get_setting('provider.greek_movies', 'false') == 'true'

def ertflix_active():
	return get_setting('provider.ertflix', 'false') == 'true'

def autoembed_active():
	return get_setting('provider.autoembed', 'false') == 'true'

def torrents_active():
	return get_setting('provider.torrents', 'false') == 'true'

def torrents_limit():
	return int(get_setting('provider.torrents_limit', '2'))

def database_sync():
	return int(get_setting('streamdb_sync', '1'))
...
def active_internal_scrapers():
	settings = ['provider.external', 'provider.furk', 'provider.easynews', 'provider.folders', 'provider.coverapi']
