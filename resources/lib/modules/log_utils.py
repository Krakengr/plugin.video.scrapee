...
ChangeLog_head = '--[Scrapee - %s - ChangeLog]--' % version
DebugLog_head = '--[Scrapee - %s - DebugLog]--' % version
DEBUGPREFIX = '[Scrapee - %s - DEBUG]' % version

LOGPATH = control.transPath('special://logpath/')
log_file = os.path.join(LOGPATH, 'scrapee.log')
